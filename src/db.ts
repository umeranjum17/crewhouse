...
export class Store {
  ...
  constructor(stateDir: string) {
    ...
    for (const [table, col] of [['tasks', 'brain TEXT'], ['tasks', 'wake_at INTEGER'], ['people', 'quiet TEXT'], ['bots', 'member INTEGER DEFAULT 1'],
      ['bots', 'account INTEGER'], ['tasks', 'member INTEGER DEFAULT 1'], ['messages', 'member INTEGER'], ['asks', 'member INTEGER'], ['tasks', 'routine INTEGER'], ['tasks', 'session TEXT'], ['routines', 'quiet INTEGER DEFAULT 0'], ['people', 'share TEXT'], ['routines', 'watch TEXT'], ['tasks', 'hops INTEGER DEFAULT 0'], ['routines', 'down INTEGER DEFAULT 0']]) {
